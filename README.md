...
[![Version](https://img.shields.io/badge/version-v1.13.0-111827)](https://github.com/aiis2/grok-register-win/releases/tag/v1.13.0)
...
- OAuth consent 动态识别当前 `submitOAuth2Consent` Server Action，支持 RSC 响应和回调重定向，并以批次指标、错误去重及熔断避免系统性故障时持续放大请求；
